const galleryCodeHtml=document.getElementById("gallery-code-html");const galleryCodeCss=document.getElementById("gallery-code-css");const galleryCodeJs=document.getElementById("gallery-code-js");function prepareGalleryCode({...params}){const{userRoundedSelect,userReverseSelect,userSlowdownSelect,numRows}=params;const galleryCodeJsText=processGalleryJsCode(numRows);const galleryCodeHtmlText=`  <!-- index.html -->
...
const galleryCodeCssText=`  /* styles.css */
    ...
    }`;galleryCodeJs.textContent=galleryCodeJsText;galleryCodeHtml.textContent=galleryCodeHtmlText;galleryCodeCss.textContent=galleryCodeCssText}
